...
import AdminOfficeSearchForm from "v2/components/admin/office-search-form";
...
const AdminSearchOffices = () => {
  ...
  const handleSearch = (e) => {
    ...
    navigate(routes.adminSearchOffices.navigate(context.searchTerm));
  };
...
export default AdminSearchOffices;
